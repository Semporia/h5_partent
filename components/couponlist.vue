  ...
  <view>
    <view class="ticket-list">
      ...
      <!-- <view class="coupon">
				...
				<view class="center">
					<p class="couponName ft18 van-ellipsis">衣物洗护33元抵用券</p>
					<p class="ft10">可使用有效期：2020年12月30日10时</p>
				</view>
				<view class="right ft14" @click="showCode(item)">
					<p class="verticalcenter"><br>立<br>即<br>使<br>用</p>
				</view>
			</view>
			<view class="coupon">
				<view class="left">
				...
				<view class="center">
					<p class="couponName ft18 van-ellipsis">CMK生啤1桶免费兑换券&nbsp;</p>
					<p class="ft10">可使用有效期：2021年2月5日18时</p>
				</view>
				<view class="right ft14">
					<p class="verticalcenter">立<br>即<br>使<br>用</p>
				</view>
			</view>
			<view class="coupon">
				<view class="left">
				...
				<view class="center">
					<p class="couponName ft18 van-ellipsis">A+健康洗车套餐</p>
					<p class="ft10">可使用有效期：2021年12月6日19时</p>
				</view>
				<view class="right ft14">
					<p class="verticalcenter">立<br>即<br>使<br>用</p>
				</view>
...
<script>
  export default {
    ...
    methods: {
      goCouponDetail(item) {
        this.NavTo('/pages/public/coupon_detail?id=' + item.activity_coupon_id);
      },
      showCode(item) {
