        ...
        <form class="van-form">
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="phone" placeholder="手机号" class="van-field__control">
          ...
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="code" placeholder="验证码" class="van-field__control">
          ...
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="password" placeholder="新密码" class="van-field__control">
