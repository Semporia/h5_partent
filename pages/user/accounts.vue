...
.ft11{font-size:.29333rem;}
.ft12{font-size:.32rem;}
.ft13{font-size:.34667rem;}
.flex{display:-webkit-box;display:-webkit-flex;display:flex;}
.flex-1{-webkit-box-flex:1;-webkit-flex:1;flex:1;}
.flex-1,.flex-jb{display:-webkit-box;display:-webkit-flex;display:flex;}
...
.menu-tabbar .active .menu-inner{color:#2599ff;}
...
.menu-tabbar .active .menu-inner{color:#2599ff;}
.menu-tabbar .menu-icon{width:.58667rem;height:.58667rem;margin:0 auto .10667rem;}
.order-item{margin:.26667rem auto 0;width:9.41333rem;box-sizing:border-box;padding:0 .4rem;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;flex-direction:column;font-size:.37333rem;background-color:#fff;border-radius:.13333rem;}
.order-item .top{display:-webkit-box;display:-webkit-flex;display:flex;height:1.06667rem;-webkit-box-align:center;-webkit-align-items:center;align-items:center;}
.order-item .center{display:-webkit-box;display:-webkit-flex;display:flex;padding:.13333rem 0 .4rem;border-bottom:.01333rem solid #eee;}
.order-item .center .img{margin-right:.4rem;box-sizing:border-box;padding:.16rem;width:1.6rem;height:1.6rem;}
.order-item .center .ft12{-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;flex-direction:column;-webkit-box-flex:1;-webkit-flex-grow:1;flex-grow:1;}
.order-item .bottom{-webkit-justify-content:space-around;justify-content:space-around;-webkit-box-align:center;-webkit-align-items:center;align-items:center;height:1.06667rem;padding-bottom:0;font-size:.26667rem;color:#909090;}
.order-item .bottom{display:-webkit-box;display:-webkit-flex;display:flex;}
.order-item .left{-webkit-box-flex:4;-webkit-flex:4;flex:4;}
.order-item .right{text-align:right;}
.order-item .green{color:#14b668;}
.order-item .small{color:#999;}
.order-item .c333{color:#333;}
.order-item .c666{color:#666;}
.order-item{margin:.26667rem auto 0;width:9.41333rem;box-sizing:border-box;padding:0 .4rem;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;flex-direction:column;font-size:.37333rem;background-color:#fff;border-radius:.13333rem;}
.order-item .top{display:-webkit-box;display:-webkit-flex;display:flex;height:1.06667rem;-webkit-box-align:center;-webkit-align-items:center;align-items:center;}
.order-item .center{display:-webkit-box;display:-webkit-flex;display:flex;padding:.13333rem 0 .4rem;border-bottom:.01333rem solid #eee;}
.order-item .center .img{margin-right:.4rem;box-sizing:border-box;padding:.16rem;width:1.6rem;height:1.6rem;}
...
.order-item .c333{color:#333;}
.order-item .c666{color:#666;}
.order-body{background-color:#f0f0f0;min-height:100%;box-sizing:border-box;}
.order-body .van-list{margin-bottom:.26667rem;}
.order-body .van-list .van-tabs__wrap{height:1.38667rem;}
.order-body .van-list .van-tabs__line{background-color:#ff7214!important;bottom:.61333rem;}
</style>
