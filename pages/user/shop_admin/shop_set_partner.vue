      ...
      <view class="formWrap">
        <form class="van-form">
          ...
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="code" placeholder="真实姓名" class="van-field__control">
              </view>
            </view>
          </view>
          ...
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="code" placeholder="公司名称" class="van-field__control">
              </view>
            </view>
          </view>
          ...
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="code" placeholder="公司简称" class="van-field__control">
              </view>
            </view>
          </view>
          ...
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="code" placeholder="赠送消费金额" class="van-field__control">
              </view>
            </view>
          </view>
          ...
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="password" placeholder="到店消费折扣 如 5% 填写 5" class="van-field__control">
              </view>
            </view>
          </view>
          ...
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="password" placeholder="收益分成 如 25% 填写 25" class="van-field__control">
              </view>
            </view>
          </view>
          ...
          <view class="van-cell van-field">
            ...
            <view class="van-cell__value van-field__value">
              <view class="van-field__body"><input type="text" name="password" placeholder="合伙人称号" class="van-field__control">
              </view>
            </view>
          </view>
